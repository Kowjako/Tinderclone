...
namespace DatingAppAPI.Persistence.Data.Migrations
{
    ...
    [Migration("20221211181449_AddGroupsForSignalRMessaging")]
    partial class AddGroupsForSignalRMessaging
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingAppAPI.Domain.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DatingAppAPI.Domain.Entities.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("DatingAppAPI.Domain.Entities.Connection", b =>
                {
            ...
            modelBuilder.Entity("DatingAppAPI.Domain.Entities.Group", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DatingAppAPI.Domain.Entities.AppUserRole", b =>
                {
                    b.HasOne("DatingAppAPI.Domain.Entities.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DatingAppAPI.Domain.Entities.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("DatingAppAPI.Domain.Entities.Connection", b =>
                {
                    b.HasOne("DatingAppAPI.Domain.Entities.Group", null)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("DatingAppAPI.Domain.Entities.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("DatingAppAPI.Domain.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
